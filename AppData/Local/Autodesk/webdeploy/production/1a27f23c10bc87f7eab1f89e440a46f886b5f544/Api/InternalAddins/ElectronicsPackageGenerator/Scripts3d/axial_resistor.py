...
def axial_resistor(params, design = None, target_comp = None):
    ...
    if is_update: 
        ...
        body_color = addin_utility.get_appearance(app, design, constant.COLOR_NAME_AXIAL_RESISTOR_BODY)
    ...
    addin_utility.apply_rgb_appearance(app, design, rev_body.bodies.item(0),color_r, color_g, color_b, constant.COLOR_NAME_AXIAL_RESISTOR_BODY)
