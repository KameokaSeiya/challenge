...
class PackageCalculatorSot143(pkg_calculator.PackageCalculator):
	...
	def get_footprint(self):
		...
		odd_pad.name = '1'
		odd_pad.roundness = footprint_utility.get_smd_pad_roundness(self.ui_data)
		...
		left_pad.name = '2'
		left_pad.roundness = footprint_utility.get_smd_pad_roundness(self.ui_data)
		...
		right_pad_bottom.roundness = footprint_utility.get_smd_pad_roundness(self.ui_data)
		...
		right_pad_top.roundness = footprint_utility.get_smd_pad_roundness(self.ui_data)
