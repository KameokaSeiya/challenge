...
class PackageCommandSoj(PackageCommand.PackageCommand):
    ...
    def validate_ui_input(self, inputs: adsk.core.CommandInputs):
        ...
        E2 = addin_utility.get_float_data(self,'terminalCenterToCenterDistance')
        if E2 >= E:
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
        ...
        soj_inputs.addIntegerSpinnerCommandInput('horizontalPadCount', _LCLZ('#Pins', '# Pins'), 2, 100 , 2, int(self.ui_data['horizontalPadCount']))
        ...
        rounded_corner = soj_inputs.addIntegerSpinnerCommandInput('roundedPadCornerSize', _LCLZ('padRoundness', 'Pad Roundness (%)'), 1, 100 , 1, int(self.ui_data['roundedPadCornerSize']))
