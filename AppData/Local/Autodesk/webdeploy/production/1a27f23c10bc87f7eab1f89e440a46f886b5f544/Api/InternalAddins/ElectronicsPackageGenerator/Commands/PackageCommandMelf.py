...
class PackageCommandMelf(PackageCommand.PackageCommand):
    ...
    def on_create(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs):
        ...
        rounded_corner = melf_inputs.addIntegerSpinnerCommandInput('roundedPadCornerSize', _LCLZ('padRoundness', 'Pad Roundness (%)'), 1, 100 , 1, int(self.ui_data['roundedPadCornerSize']))
    ...
    def on_input_changed(self, command: adsk.core.Command, inputs: adsk.core.CommandInputs, changed_input: adsk.core.CommandInput, input_values: dict ):
        ...
        if changed_input.id == 'componentFamily':
            ...
            component_family = list(MELF_FAMILY_TYPES.values())[inputs.itemById('componentFamily').selectedItem.index]
