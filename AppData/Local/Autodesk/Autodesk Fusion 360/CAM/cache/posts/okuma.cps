/**
  ...
  $Revision: 43326 f2312a0ddd4307a5b1eafd19422fee6c928a4529 $
  $Date: 2021-06-22 09:50:41 $
...
function initializeSmoothing() {
  ...
  smoothing.force = !isFirstSection() && feedFormat.areDifferent(getPreviousSection().getMaximumFeedrate(), currentSection.getMaximumFeedrate());
}
