...
function onSection() {
  ...
  if (currentSection.isMultiAxis()) {
    ...
    if (tcpIsSupported || !machineConfiguration.isMultiAxisConfiguration()) {
      writeBlock("TRAORI");
    }
...
function onSectionEnd() {
  ...
  if (currentSection.isMultiAxis() && (tcpIsSupported || !machineConfiguration.isMultiAxisConfiguration())) {
    writeBlock("TRAFOOF");
