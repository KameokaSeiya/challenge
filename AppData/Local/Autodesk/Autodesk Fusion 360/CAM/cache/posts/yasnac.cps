/**
  ...
  $Revision: 43344 fb63099b5d810a74ecb1dcf807acfd08aa282575 $
...
function onSection() {
  ...
  if (forceMultiAxisIndexing || machineConfiguration.isMultiAxisConfiguration()) { // use 5-axis indexing for multi-axis mode
