/**
  ...
  $Revision: 43323 6f3498f4b7511fc1422d8e1e50e27b5a9ace0175 $
  $Date: 2021-06-18 13:00:57 $
...
function onSection() {
  ...
  if (insertToolCall || retracted || operationNeedsSafeStart || !lengthCompensationActive ||
    ...
    if (currentSection.isMultiAxis()) {
      skipBlock = _skipBlock;
      writeBlock(gMotionModal.format(0), gFormat.format(234), hFormat.format(lengthOffset));
    }
